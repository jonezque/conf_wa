...
var ASM_CONSTS = {
  1180: function() {console.log('console from main.cpp')},  
 1218: function($0, $1) {console.log('a = ', $0, ' b = ', $1)},  
 1258: function($0) {console.log('hello ' + Module.UTF8ToString($0))},  
 1315: function($0, $1) {return $0 + $1;},  
 1345: function() {const msg = "string from JS"; const byteCount = (Module.lengthBytesUTF8(msg) + 1); const greetingsPointer = Module._malloc(byteCount); Module.stringToUTF8(msg, greetingsPointer, byteCount); return greetingsPointer;}
};
...
function WithParams(a,b){ console.log("WithParams", a, b); return a + b; }
...
var asmGlobalArg = {};
var asmLibraryArg = { "NoReturnValueWithNoParameters": NoReturnValueWithNoParameters, "WithParams": WithParams, "__cxa_atexit": ___cxa_atexit, "__handle_stack_overflow": ___handle_stack_overflow, "__map_file": ___map_file, "__sys_munmap": ___sys_munmap, "abort": _abort, "emscripten_asm_const_dii": _emscripten_asm_const_dii, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "strftime_l": _strftime_l, "table": wasmTable };
var asm = createWasm();
/** @type {function(...*):?} */
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = createExportWrapper("__wasm_call_ctors");

/** @type {function(...*):?} */
var ___em_js__NoReturnValueWithNoParameters = Module["___em_js__NoReturnValueWithNoParameters"] = createExportWrapper("__em_js__NoReturnValueWithNoParameters");

/** @type {function(...*):?} */
var ___em_js__WithParams = Module["___em_js__WithParams"] = createExportWrapper("__em_js__WithParams");
